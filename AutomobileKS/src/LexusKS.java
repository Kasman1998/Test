...
/**
 *The LexusKS class is a subclass that inheriting variables in the superclass(Auto-
 * mobilesKS and implementing method from implementing the AutoInt interface.
 * @author Kasman98
 */
public class LexusKS extends AutomobilesKS implements AutoInt{
    /**
     ...
     * @param cost
     */
    public LexusKS(String type, String model, int year, String color, String dealer, double cost) {
